    ...
    <body>
        <table>
            <tr>
                ...
                pstmt.setInt(4,Integer.parseInt(request.getParameter("GRADESTATUS")));
...
"UPDATE COURSE SET COURSEID = ?,COURSENUMBER = ?, UNIT = ?,GRADESTATUS = ?, PREREQUISITES = ?," +
"GENERALTOPIC = ?, INSTRUCTORCONSENT = ?,ISREQUIREDLABWORK = ?  WHERE ISLOWER = ?");
pstatement.setInt(1,Integer.parseInt(request.getParameter("COURSEID")));
pstatement.setString(2, request.getParameter("COURSENUMBER"));
pstatement.setInt(3,Integer.parseInt(request.getParameter("UNIT")));
pstatement.setInt(4,Integer.parseInt(request.getParameter("GRADESTATUS")));
...
pstatement.setBoolean(9, Boolean.parseBoolean(request.getParameter("ISLOWER")));
